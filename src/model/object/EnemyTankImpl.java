...
public class EnemyTankImpl extends AbstractTank {
     ...
     */
    public EnemyTankImpl(final Pair<Double, Double> position, final int lifes, final double speed, final double projectileSpeed) {
