 ...
 * <p>
 * Memorize next movement of Tank.
 * Directions are memorized in a {@link Map}, where keys are {@link Direction} and values are {@link Boolean}.
 * Values become true where tank need to be moved.
 * 
 * @see InputImpl
 * @see TankImpl
 */
