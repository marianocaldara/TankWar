...
public class TankWithProjectile implements Collision { 
     ...
     */
    public TankWithProjectile(final AbstractTank playerTank, final AbstractTank enemyTank, final List<Projectile> projectiles) {
    ...
    private static void updateTankLifeAndProjectiles(final AbstractTank tank, final List<Projectile> hitProjectiles) {
